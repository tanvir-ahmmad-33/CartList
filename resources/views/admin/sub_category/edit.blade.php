	...
	<div class="container-fluid my-2">
		<div class="row mb-2">
			...
			<div class="col-sm-6 text-right">
				<a href="{{ route('sub-categories.index') }}" class="btn btn-primary btn-sm">Back</a>
			</div>
		</div>
	</div>
	<!-- /.container-fluid -->
...
<section class="content">
	...
	<div class="container-fluid">
        <form action="" name="subCategoryForm" id="subCategoryForm" class="subCategoryForm">
		    <div class="card">
			    <div class="card-body">								
				    <div class="row">
                        <div class="col-md-12">
...
<script>
    $('#subCategoryForm').submit(function(e) {
        ...
        $.ajax({
            url: '{{ route("sub-categories.update", ["id" => ":id"]) }}'.replace(':id', subCategoryId),
            type: 'put',
            data: data,
            dataType: 'json',
